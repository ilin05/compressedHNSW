...
namespace camel {
    ...
    public:
        ...
        DoubleCamelDecoder(std::shared_ptr<utils::BaseBlockStreamReader> sharedIn);
        DoubleCamelDecoder(std::shared_ptr<utils::BaseBlockStreamReader> sharedIn, const std::string& config);
