...
namespace camel {
    ...
    public:
        ...
        DoubleCamelEncoder(std::shared_ptr<utils::BaseStreamWriter> sharedOut);
        DoubleCamelEncoder(std::shared_ptr<utils::BaseStreamWriter> sharedOut, const std::string& config);
