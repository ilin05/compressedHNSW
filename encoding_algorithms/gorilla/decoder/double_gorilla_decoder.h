...
namespace gorilla {
    ...
    public:
        ...
        DoubleGorillaDecoder(std::shared_ptr<utils::BaseBlockStreamReader> sharedIn);
        DoubleGorillaDecoder(std::shared_ptr<utils::BaseBlockStreamReader> sharedIn, const std::string& config);
