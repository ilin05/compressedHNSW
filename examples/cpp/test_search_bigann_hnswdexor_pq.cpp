...
int main(int argc, char** argv) {
    ...
    for (size_t m : subsets) {
        const size_t cache_size = (m * 1000000ULL) / 100;
        ...
        std::cout << "\n=== Searching HNSWDEXOR_PQ for " << bigann_test_utils::subset_label(m) << " ===" << std::endl;
        HierarchicalNSWCABLEANNPQ<double> index(&l2space, index_file, true, cache_size);
