...
void test_search_dataset(const std::string& dataset_name, const std::string& base_dir, std::ofstream& csv_file) {
    ...
    // 如果你在构建后缀没有修改名称，这里可能是 fashion-mnist-784-euclidean_train.fvecs_hnswalp_simplified_pq.bin 等
...
int main(int argc, char** argv) {
    ...
    std::string csv_file_path = "hnswalp_simplified_pq_search_recall_results.csv";
