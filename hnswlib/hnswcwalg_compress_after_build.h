...
class HierarchicalNSWCAB : public AlgorithmInterface<dist_t> {
 public:
    ...
    HierarchicalNSWCAB(SpaceInterface<dist_t> *s) {
    }
    ...
    HierarchicalNSWCAB(
        ...
        if (linkLists_ == nullptr)
            throw std::runtime_error("Not enough memory: HierarchicalNSWCAB failed to allocate linklists");
