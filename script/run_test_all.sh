...
../build/test_search_faiss_hnsw_pq_sq --algorithm HNSWPQ HNSWSQ --pq_m 1 2 ----sq_nbits 4 8
bash test_search_faiss_IVF.sh
bash test_search_faiss_nsg.sh
