...
echo "Running all HNSW bigann tests"

echo "==================================="
echo "1. Running Build Tests"
echo "==================================="
# bash run_build_bigann_hnsw.sh
# bash run_build_bigann_hnswalp_pq.sh
...
../build/test_search_bigann_faiss_hnsw_pq_sq --algorithm HNSWPQ HNSWSQ --pq_m 1 2 ----sq_nbits 4 8 --dataset bigann_1M bigann_10M
