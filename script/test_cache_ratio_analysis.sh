...
../build/test_cache_ratio_analysis --dataset gist-960-euclidean_train.fvecs sift-128-euclidean_train.fvecs mnist-784-euclidean_train.fvecs --cache-ratios 0.0 --num-rounds 10
